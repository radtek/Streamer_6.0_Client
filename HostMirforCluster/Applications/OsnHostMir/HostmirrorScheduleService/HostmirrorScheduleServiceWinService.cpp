// HostmirrorScheduleService.cpp : main Windows Service project file.

#include "stdafx.h"
#include <string.h>
#include "HostmirrorScheduleServiceWinService.h"

using namespace HostmirrorScheduleService;
using namespace System::Text;
using namespace System::Security::Policy;
using namespace System::Reflection;

//To install/uninstall the service, type: "HostmirrorScheduleService.exe -Install [-u]"
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		ServiceBase::Run(gcnew HostmirrorScheduleServiceWinService());
	}
}

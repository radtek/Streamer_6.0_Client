...
#define	OSN_REG_SERVER			"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\OSNCliService"
#define	OSN_REG_SERVERPARA		"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\OSNCliService\Parameters"

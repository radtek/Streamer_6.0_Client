...
enum st_res_code
{
	...
	ST_RES_FAILED,
	ST_RES_CMD_FINISHED,
	ST_RES_CMD_NOT_SUPPORT,
	ST_RES_XML_PARSE_ERROR,
	ST_RES_BACKUP_TARGET_NOT_FOUND,
	ST_RES_CLIENT_UNPROTECT = 50,
	ST_RES_CLIENT_LOST,
	ST_RES_CLIENT_SEND_ERROR,
	ST_RES_CLIENT_RECV_ERROR,
	ST_RES_CLIENT_CMD_FAILED,
	ST_RES_CLIENT_TIMEOUT,
	ST_RES_CLIENT_CONN_ERROR,
	ST_RES_CLIENT_SAN_MAP_FAILED = 80,
	ST_RES_CLIENT_SAN_CREATE_VOL_FAILED,
};
...
enum st_op_code
{
	...
	ST_OP_GET_SERVER_INFO,
	ST_OP_ADD_DISKS_TO_POOL,
	ST_OP_DEL_DISKS_FROM_POOL,
